//
//  FoodIdentifierModelHandler.swift
//  Phaze
//
//  Created by Kevin Bortas on 11/04/2022.
...
class ImagePredictor {
    ...
    static func createImageClassifier() -> VNCoreMLModel {
        ...
        let imageClassifierWrapper = try? NewFoodClassifierPhaze2022_3(configuration: defaultConfig)
